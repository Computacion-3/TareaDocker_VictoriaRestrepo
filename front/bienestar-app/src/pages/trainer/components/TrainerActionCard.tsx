...
function TrainerActionCard({
  ...
  return (
    <GlassCard variant="dashboard" sx={{ display: "flex", flexDirection: "column", gap: 2, minHeight: 250 }}>
...
export default TrainerActionCard;
